...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $user->identification_number],
                ['confirm' => __('Are you sure you want to delete # {0}?', $user->identification_number)]
            )
        ?></li>
...
<div class="users form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('lastname1');
            echo $this->Form->control('lastname2');
            echo $this->Form->control('username');
            echo $this->Form->control('email_personal');
