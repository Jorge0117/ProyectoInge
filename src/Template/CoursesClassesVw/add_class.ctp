    ...
    <fieldset>
        ...
        <div class="form-section">
            ...
            <?php
                ...
                echo $this->Form->control('Semestre', ['label'=>['text'=>'Ciclo'],'type' => 'number','max' => 2, 'min' => 1,'required']);
                echo $this->Form->control('Año', ['label'=>['text'=>'Año'],'type' => 'number','max' => 9999, 'min' => 1900,'required']);
